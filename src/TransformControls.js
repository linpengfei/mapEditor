...
const {
	...
	BoxBufferGeometry,
	BufferGeometry,
	CylinderBufferGeometry, Float32BufferAttribute, Line,
	Matrix4,
	Mesh,
	MeshBasicMaterial, Object3D, OctahedronBufferGeometry,
	OrthographicCamera,
	PerspectiveCamera,
	PlaneBufferGeometry,
	Raycaster, SphereBufferGeometry, TorusBufferGeometry
} = THREE;
...
const TransformControlsGizmo = function () {
	...
	var gizmoMaterial = new MeshBasicMaterial({
		...
		depthWrite: false, // 深度缓冲区影响
		transparent: true,
		side: DoubleSide, // 渲染两面
		fog: false // 关闭雾化影响
	});
	// 线框材质
	...
	var gizmoTranslate = {
		...
		// 八面体，xyz三方向移动使用， xy,yz,xz都为三个平面形式
		XYZ: [
